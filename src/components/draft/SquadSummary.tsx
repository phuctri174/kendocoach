  ...
  return (
    <section className="flex flex-col items-center gap-4 sm:gap-10">
      <div className="flex flex-col items-center gap-1.5 text-center sm:gap-3">
        ...
        <h2 className="display text-xl text-brass-300 sm:text-3xl">Đã chốt đội hình</h2>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
        <button
          type="button"
          onClick={onStart}
          className="hex-tab bg-brass-400 px-8 py-2.5 text-forest-900 transition-colors hover:bg-brass-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brass-200 sm:px-10 sm:py-4"
        >
