...
export function MatchViewer({
  ...
  // scrollable ancestor into view, which is exactly what must NOT happen now
  // that the rest of the page is deliberately non-scrolling (see the layout
  // comment below): this must only ever move the log panel's own scrollbar.
  useEffect(() => {
